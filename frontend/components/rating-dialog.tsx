...
export default function RatingDialog({ appointment, open, onClose, onRate }: RatingDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Hãy chia sẻ trải nghiệm của bạn với {appointment.doctor_name} vào ngày{" "}
